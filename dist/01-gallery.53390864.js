...
parcelHelpers.export(exports, "galleryItems", ()=>(0, _galleryItems.galleryItems));
...
const cardsGallery = (0, _galleryItems.galleryItems).map((item)=>`
...
const galleryLightbox = new (0, _simplelightboxDefault.default)(".js-gallery a", {
    captionDelay: 250,
    captionsData: "alt",
    showCounter: false
});
